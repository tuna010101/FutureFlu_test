#!/usr/bin/env python3
"""Write the release divergence component slice.

English: This step keeps the divergence signal in a small standalone table.
中文：这个步骤把 divergence 信号整理成独立的小表。
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Split the divergence component table.")
...
def main() -> int:
    ...
    component_df[KEY_COLUMNS + ["mutual_information"]].to_csv(
        part_dir / "component_divergence.csv", index=False
    )
    return 0
